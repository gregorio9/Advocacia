...
## 12. Registro específico do especialista em Due Diligence Imobiliária

O presente especialista foi estruturado com base no template da Biblioteca Jurídica Gregório, com foco em Due Diligence Imobiliária e em uma atuação técnica, fundamentada e compatível com a prática profissional de advogado especializado na matéria.
...
- adaptação do escopo para temas relacionados à Due Diligence Imobiliária, inclusive auditoria documental, análise de matrícula, cadeia dominial, certidões, ônus reais, gravames, ações judiciais, regularidade registral, urbanística, ambiental, fiscal, contratual e análise de riscos em operações imobiliárias;
...
## Versão 1.0.0 — Especialista em Due Diligence Imobiliária

- Criação do especialista em Due Diligence Imobiliária com base no template da Biblioteca Jurídica Gregório.
- Estruturação inicial dos documentos de identidade, regras, prompt, checklist, casos de teste e histórico.
- Definição do escopo de atuação voltado à auditoria jurídica imobiliária, com foco na análise documental, identificação de riscos, regularidade registral, urbanística, ambiental, fiscal, contratual e jurisprudência.
...
- Ajuste do pacote documental do especialista para refletir uma postura técnica, objetiva e compatível com a atuação profissional de advogado especializado em Due Diligence Imobiliária.
- Revisão de coerência entre identidade, regras, prompt, checklist e casos de teste.
- Ampliação das verificações de revisão para incluir matrícula, cadeia dominial, certidões, ônus, gravames, regularidade urbanística, ambiental, fiscal, contratos, registros e precedentes jurisprudenciais relevantes.
...
- Os documentos README.md e 01_IDENTIDADE.md a 08_MELHORIAS.md foram adaptados à Due Diligence Imobiliária.
...
## Versão 1.3.0 — Reconstrução e saneamento documental — 22/08/2026

- Identificado que `README.md`, `01_IDENTIDADE.md`, `02_REGRAS.md`, `03_PROMPT.md`, `04_CHECKLISTS.md` e `08_MELHORIAS.md` ainda continham instruções de adaptação, apesar dos registros anteriores de homologação.
- Os seis documentos foram substituídos por versões operacionais próprias de Due Diligence Imobiliária.
- Foram definidas regras de escopo, data de corte, rastreabilidade documental, classificação de riscos, diligências, mitigação e conclusão condicionada.
- Foram removidas frases residuais de geração dos arquivos `05_CASOS_DE_TESTE.md`, `06_HISTORICO.md` e `07_REFERENCIAS.md`.
